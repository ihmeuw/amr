...
SOURCE['pathogen'] = 'neisseria_gonorrheae'
SOURCE = SOURCE.rename(columns = {'nid':'source', 'n_resistant':'resistant', 'sample_size':'cases', 'antibiotic':'abx_class'})
SOURCE['susceptible'] = SOURCE['cases'] - SOURCE['resistant']
SOURCE2 = SOURCE.loc[:,['location_id', 'year_id', 'source', 'pathogen', 'abx_class', 'resistant', 'susceptible', 'cases']]
fqgonosum = fqgonosum.append(SOURCE2)
